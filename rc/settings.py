...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT, 'rc/rc.db'),                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(SITE_ROOT, 'rc/templates'),
    os.path.join(SITE_ROOT, 'rc/templates/resources')
)
