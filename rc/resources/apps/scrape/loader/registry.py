...
# register operations
etl.register(parsers.CommuterSurvey, loader.CommuterSurveyLoader,
             'operations.CommuterSurvey')
etl.register(parsers.WebsiteCampusGreenBuilding, loader.GenericLoader,
             'operations.GreenBuildingWebsite')
etl.register(parsers.UniversalAccess, loader.TransitPassLoader,
             'operations.TransitPass')
etl.register(parsers.SustainabilityPurchasing,
             loader.SustainabilityPurchasingLoader, 'operations.PurchasingLink')
etl.register(parsers.SustainableLandscaping, loader.GenericLoader,
             'operations.SustainableLandscape')
etl.register(parsers.SustainableDiningInitiatives,
             loader.SustainableDiningInitiativesLoader,
             'operations.DiningInitiative')
etl.register(parsers.FuelCells, loader.GenericLoader, 'operations.FuelCell')
etl.register(parsers.RenewableEnergyResearchCenters, loader.GenericLoader,
             'operations.RenewableResearchCenter')
# TODO Publications on Climate Action
# BEGIN Green Buildings
etl.register(parsers.GreenAthleticBuilding, loader.GreenBuildingLoader,
             'operations.CampusGreenBuilding')
etl.register(parsers.GreenLibrary, loader.GreenBuildingLoader,
             'operations.CampusGreenBuilding')
...
etl.register(parsers.GreenScience, loader.GreenBuildingLoader,
             'operations.CampusGreenBuilding')
# END Green Buildings
etl.register(parsers.WindTurbine, loader.WindTurbineLoader,
             'operations.WindTurbine')
etl.register(parsers.WaterConservation, loader.GenericLoader,
             'operations.WaterConservationEffort')
etl.register(parsers.HybridVehicles, loader.HybridFleetLoader,
             'operations.HybridFleet')
etl.register(parsers.GlobalWarmingCommitment, loader.GenericLoader,
             'operations.GlobalWarmingCommitment')
etl.register(parsers.CampusEnergyWebsite, loader.GenericLoader,
             'operations.EnergyWebsite')
etl.register(parsers.CampusEnergyPlan, loader.GenericLoader,
             'operations.EnergyPlan')
etl.register(parsers.ElectricVehicleFleet, loader.GenericLoader,
             'operations.ElectricFleet')
etl.register(parsers.CarBan, loader.CarBanLoader, 'operations.CarBan')
etl.register(parsers.BiodieselFleet, loader.BiodieselFleetLoader,
             'operations.BiodieselFleet')
etl.register(parsers.BicyclePlans, loader.GenericLoader,
             'operations.BicyclePlan')
etl.register(parsers.BuildingEnergyDashboard, loader.BuildingDashboardLoader,
             'operations.BuildingDashboard')
etl.register(parsers.AlternativeTransport, loader.GenericLoader,
             'operations.TransportationWebsite')
etl.register(parsers.BottledWaterBans, loader.BottleWaterBanLoader,
             'operations.BottledWaterBan')
